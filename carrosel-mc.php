    ...
    <main>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active"> 
                <img style="width: 100%; height: 408px;" src="img/gremio-meias.jpg">
            ...
            <?php
            while ($dados_jogadores_mc = $rs_jogadores_mc->fetch(PDO::FETCH_ASSOC)) {
            
            // Pegamos os dados da linha e guardamos em variáveis...
            $mc_nome = $dados_jogadores_mc["nome"];
            $mc_posicao = $dados_jogadores_mc["posicao"];
            $mc_img = $dados_jogadores_mc["img"];
            
            //...usamos as variáveis para preencher o template
            $template_jogador_mc = "
            <div class='carousel-item'> 
                <img style='width: 100%;' src='img/jogadores/$mc_img.jpg'>
                <div class='container'>
                    <div class='carousel-caption text-start'>
                        <h4 style='color: white; background-color: darkgray; text-align: center; border-radius: 20px;'>$mc_nome/$mc_posicao</h4 style='color: white; background-color: darkgray; text-align: center; border-radius: 20px;'>
                    </div>
                </div>
            </div>
            ";
